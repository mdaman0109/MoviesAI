  ...
  return (
    <div className="relative w-full min-h-screen">
      ...
      <div className="relative z-30 flex flex-col justify-start items-center pt-30 sm:pt-38 md:pt-32 lg:pt-40 xl:pt-44 px-2 sm:px-4 md:px-6 lg:px-8">
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl p-4 rounded-4xl bg-black/20 backdrop-blur-sm border border-white/20 xl:text-5xl text-shadow-red-900 text-shadow-xs font-semibold text-center text-white  mb-4 sm:mb-5 md:mb-6 px-2 sm:px-4 leading-tight sm:leading-snug max-w-4xl">
