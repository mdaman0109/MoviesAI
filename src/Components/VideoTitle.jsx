...
const VideoTitle = ({ title, overview,movieId }) => {
  return (
    <div className="absolute inset-0 z-10 px-6 sm:px-16  md:px-24 sm:pt-[5vh] pt-[10vh] md:pt-[15vh] lg:pt-[35vh] text-white bg-gradient-to-r from-black-100">
  <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-4">{title}</h1>
  <p className="text-xs sm:text-4xl md:text-sm lg:text-lg font-medium w-full sm:w-3/4 md:1/2 lg:w-1/3 mb-6 text-gray-200">{overview}</p>
